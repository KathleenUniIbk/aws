const COLORS = {
  ...
  wind: [
    ...
    {min: 80, max: 2000, color:"#ff3232"},
  ],
  snow:[
    {min: -100, max: 1, color:"#9f80ff"},
    {min: 1, max: 10, color:"#784cff"},
    {min: 10, max: 25, color:"#0f5abe"},
    {min: 25, max: 50, color:"#1380ff"},
    {min: 50, max: 100, color:"#19cdff"},
    {min: 100, max: 200, color:"#8fffff"},
    {min: 200, max: 300, color:"#b0ffbc"},
    {min: 300, max: 400, color:"#ffff73"},
    {min: 400, max: 10000, color:"#ffbe7d"},
  ],
  direction: [
    {min: -100, max: 5, color:"#ffff64"},
    {min: 5, max: 10, color:"#c8ff64"},
